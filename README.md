...
*   **Mục tiêu dự án:** Xây dựng một hệ sinh thái giám sát kép thông minh:
    ...
    2.  **Hệ thống đeo tay (Wearable Board):** Nhận diện hành vi con người (Đứng yên, Đi bộ, Té ngã) bằng mô hình Học máy nhúng (Edge AI) chạy trực tiếp trên thiết bị (On-device Inference).
...
```mermaid
flowchart TD
    subgraph Wearable["1. KHỐI ĐEO TAY (Wearable Sub-Board)"]
...
#### Khối Đeo Tay (XIAO ESP32-S3 Sub-board)
| Linh kiện | Chân GPIO | Vai trò / Phương thức giao tiếp |
| :--- | :--- | :--- |
...
## 🏃 CHƯƠNG IV: THIẾT BỊ ĐEO TAY - AI NHẬN DIỆN TÉ NGÃ EDGE AI
...
*   **Slide 1: Tiêu đề & Giới thiệu:** Tên dự án, giải pháp kết hợp đột phá giữa Giám sát môi trường & Trí tuệ nhân tạo đeo tay (Edge AI) - Phiên bản Báo cáo Tiến độ.
